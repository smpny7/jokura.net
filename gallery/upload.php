...
<body>
    ...
    <main>
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" id="galleryPhotographer" name="galleryPhotographer" placeholder="MinecraftIDを入力" value="<?php if (!empty($_POST["galleryPhotographer"])) {
                                                                                                                            echo htmlspecialchars($_POST["galleryPhotographer"], ENT_QUOTES);
                                                                                                                        } ?>">
