...
<body>
    ...
    <main>
        ...
        <div class="city_container">
            <a href="/map<?php if (toshiCheck($_GET['region'])) {
                                echo "/toshi.php";
                            } ?>"><img class="city_back" src="/assets/img/back.png" alt="画像" oncontextmenu="return false;" onselectstart="return false;" onmousedown="return false;"></a>
