...
<body>
    ...
    <main>
        ...
        <div class="block"></div>
        <div class="server_box1"><img id="server_working" src="/assets/img/notWorking.png" alt="画像" oncontextmenu="return false;" onselectstart="return false;" onmousedown="return false;">
            <div id="server_text_1">サーバ停止中</div>
        </div>
        <div class="server_box2">
            <div id="server_text_2">- - - - - - - - - - - - - -</div>
            <div id="server_text_3">サーバアドレス</div>
        </div>
        <div class="server_box3">
            <div id="server_text_4">- / -</div>
            <div id="server_text_5">メンバー</div>
        </div>
        <div class="server_box4">
            <div id="server_text_6">- - - - -</div>
            <div id="server_text_7">バージョン</div>
        </div>
        <div class="server_box5">
            <div id="server_text_8">- - - - -</div>
            <div id="server_text_9">RCON</div>
        </div>
        <div class="block"></div>
    </main>
</body>
