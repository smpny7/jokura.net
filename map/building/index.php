...
<body>
    ...
    <main>
        ...
        <div class="city_container">
            ...
            <div class="city_list_title">製作者</div><div class="city_list_content"><?php echo $building[2]?></div>
            <div class="city_bar"></div>
            <div class="city_list_title">コメント</div><div class="city_list_content"><?php echo $building[3]?></div>
            <div class="city_bar"></div>
            <div class="city_list_title">ゲーム内座標</div><div class="city_list_content">(x,y,z)=<?php echo str_replace('_', ',', $building[4]);?></div>
            <div class="city_bar"></div>
        </div>
